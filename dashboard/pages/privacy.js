  ...
  <>
    ...
    <main className={styles.main}>
      <p>
        ...
        <a href="https://discord.com/users/643103079679393792">Manatee#6746</a>{" "}
        to a server, or as a member of a server with Manatee in it.
      </p>
      <h2>Terminology</h2>
      <p>
      ...
      <ul>
        <li>
          <strong>Server Manager</strong>: Anyone with the ability to add
          Manatee to a server or configure the server’s preferences on our
          dashboard (usually moderators, administrators, and the owner).
        </li>
        <li>
      ...
      <p>
        ...
        intentionally provided by a user, either by executing a command on
        Discord or interacting with our website. This data will not be collected
      ...
      <p>
        ...
        happen within their server, including, but not limited to, the
        following:
      </p>
      <ul>
      ...
      <p>
        ...
        you are advised to contact the Server Managers directly with any
        relevant questions.
      </p>
      ...
      <p>
        ...
        data is cached in memory while the bot is running, and it is not stored
        on our servers.
      </p>
      <h2>Data Collected Via Authorization</h2>
      <p>
        The following data may be accessed by Manatee when authorized, such as
        when logging to this website via Discord OAuth2. This data is also
        listed when you authorize Manatee.
      </p>
      <ul>
      ...
      <p>
        ...
        <a href="https://www.postgresql.org/">PostgreSQL</a> database. Please
        keep in mind that even with these protections, no data can be 100%
        secure. All efforts are taken to keep your data secure and private, but
        its absolute security cannot be guaranteed.
      </p>
      <h2>Agreement</h2>
      <p>
        By adding Manatee to your server or by being present in a server
        including Manatee, you consent to the policies outlined in this
        document. In addition, you (the Server Manager) assume the
        responsibility of informing your members of the contents of this
        document. If you, the Server Manager, do not agree to this document, you
        may remove Manatee from your Discord server. If you, the Server Member,
        do not agree to this document, you may leave the server(s) that include
        Manatee. If you, the Service User, do not agree to this document, you
        may revoke Manatee’s access to your data by going to Discord &gt; User
